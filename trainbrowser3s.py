...
def main():
    ...
    with open('./mytestdata/suggestbrowser3screens_incomplete.json', 'r') as f:
...
#    suggestions = {}
    ...
    for filename in os.listdir("./mytestdata/browser3screens"):
        if filename.endswith(".csv"):
            ...
            df = pd.read_csv('./mytestdata/browser3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/browser3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_browser3screens'
            ...
            pred_df = pd.read_csv('./mytestdata/browser3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestbrowser3screens.json', 'w') as outfile:
