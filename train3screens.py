...
#                continue
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_3screens'
...
#                print(rankings(row['source'],out_dict))
        ...
        with open('./mytestdata/suggest3screen.json', 'w') as outfile:
