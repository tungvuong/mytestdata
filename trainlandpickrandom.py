...
def main():
    ...
    with open('./mytestdata/land_pickrandom3s.json', 'r') as f:
...
#    suggestions = {}
    ...
    for filename in os.listdir("./mytestdata/land_pickrandom3s"):
        if filename.endswith(".csv"):
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/land_pickrandom3s/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_land_pickrandom3s'
...
#            continue
            pred_df = pd.read_csv('./mytestdata/land_pickrandom3s/'+filename)[splitindex:]
...
#                print(rankings(row['source'],out_dict))
        ...
        with open('./mytestdata/land_pickrandom3s.json', 'w') as outfile:
