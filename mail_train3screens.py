...
#    print(userindex.keys())
    ...
    for filename in os.listdir("./mytestdata/mail3screens"):
...
#                continue
            ...
            __data = pd.read_csv('./mytestdata/mail3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/mail3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/mail_'+user+'_3screens'
            ...
            pred_df = pd.read_csv('./mytestdata/mail3screens/'+filename)[modified_splitindex:]
...
#                print(rankings(row['source'],out_dict))
        ...
        with open('./mytestdata/mail_suggest3screen.json', 'w') as outfile:
