...
def main():
    ...
    with open('./mytestdata/suggestland_nonbrowser3screens.json', 'r') as f:
...
#    suggestions = {}
    ...
    for filename in os.listdir("./mytestdata/land_nonbrowser3screens"):
        if filename.endswith(".csv"):
            ...
            df = pd.read_csv('./mytestdata/land_nonbrowser3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/land_nonbrowser3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_land_nonbrowser3screens'
...
#            continue
            pred_df = pd.read_csv('./mytestdata/land_nonbrowser3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestland_nonbrowser3screens.json', 'w') as outfile:
