...
def main():
    ...
    with open('./mytestdata/suggestprevpage.json', 'r') as f:
...
#    suggestions = {}
    ...
    for filename in os.listdir("./mytestdata/prevpage"):
...
#                continue
            ...
            df = pd.read_csv('./mytestdata/prevpage/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/prevpage/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_prevpage'
            ...
            pred_df = pd.read_csv('./mytestdata/prevpage/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestprevpage.json', 'w') as outfile:
