...
#                continue
            ...
            for index, row in pred_df.iterrows():
                ...
                suggestions[user].append([row['title'],row['target'],pred_target,row['source'],index])
    #    break

    with open('./mytestdata/suggest1screen.json', 'w') as outfile:
