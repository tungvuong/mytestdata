...
def main():
    ...
    with open('./mytestdata/suggestsession.json', 'r') as f:
...
#    suggestions = {}
    ...
    for filename in os.listdir("./mytestdata/querysession"):
...
#                continue
            ...
            df = pd.read_csv('./mytestdata/querysession/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/querysession/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_session'
            ...
            pred_df = pd.read_csv('./mytestdata/querysession/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestsession.json', 'w') as outfile:
