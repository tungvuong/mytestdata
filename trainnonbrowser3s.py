...
def main():
    ...
    for filename in os.listdir("./mytestdata/nonbrowser3screens"):
        if filename.endswith(".csv"):
            ...
            df = pd.read_csv('./mytestdata/nonbrowser3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/nonbrowser3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_nonbrowser3screens'
            ...
            pred_df = pd.read_csv('./mytestdata/nonbrowser3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestnonbrowser3screens.json', 'w') as outfile:
