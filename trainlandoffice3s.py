...
#                continue
            ...
            df = pd.read_csv('./mytestdata/land_office3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/land_office3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_land_office3screens'
...
#            continue
            pred_df = pd.read_csv('./mytestdata/land_office3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestland_office3screens.json', 'w') as outfile:
