...
#    with open('./mytestdata/suggestland_browser3screens.json', 'r') as f:
...
#    print(userindex.keys())
    ...
    for filename in os.listdir("./mytestdata/land_browser3screens"):
...
#                continue
            ...
            df = pd.read_csv('./mytestdata/land_browser3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/land_browser3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_land_browser3screens'
...
#            continue
            pred_df = pd.read_csv('./mytestdata/land_browser3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestland_browser3screens.json', 'w') as outfile:
