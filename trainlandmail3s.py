...
#    with open('./mytestdata/suggestland_mail3screens.json', 'r') as f:
#        userindex = json.load(f)
#    suggestions = userindex
#    print(userindex.keys())
    suggestions = {}
    with open('./mytestdata/landmailindex.json') as json_file:
        queryindex = json.load(json_file)
    for filename in os.listdir("./mytestdata/land_mail3screens"):
...
#                continue
            ...
            df = pd.read_csv('./mytestdata/land_mail3screens/'+filename)
            ...
            summary_data = SummaryDataModule(tokenizer, './mytestdata/land_mail3screens/'+filename,
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_land_mail3screens'
...
#            continue
            pred_df = pd.read_csv('./mytestdata/land_mail3screens/'+filename)[splitindex:]
        ...
        with open('./mytestdata/suggestland_mail3screens.json', 'w') as outfile:
