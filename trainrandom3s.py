...
def main():
    ...
    for filename in os.listdir("./mytestdata/random3s"):
        if filename.endswith(".csv"):
            ...
            ckpt_dir = './checkpoint_files_2/'+user+'_random3s'
            ...
            pred_df = pd.read_csv('./mytestdata/random3s/'+filename)[splitindex:]
...
#                print(rankings(row['source'],out_dict))
        ...
        with open('./mytestdata/suggestrandom3s.json', 'w') as outfile:
